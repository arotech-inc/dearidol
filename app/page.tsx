  ...
  useEffect(() => {
    ...
    const syncVideos = () => {
      if (mql.matches) {
        ...
        systemVideoRef.current?.pause();
        mobileVideoRef.current?.play().catch(() => {});
      }
    };
    syncVideos();
    mql.addEventListener("change", syncVideos);
    return () => mql.removeEventListener("change", syncVideos);
  }, []);
      ...
      <section id="growth" className="snap-section relative md:min-h-screen md:flex md:items-center py-16 md:py-24 lg:py-32 overflow-hidden bg-[#0a0a0f]">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 w-full relative z-10">
          ...
          >
            ...
            <p className="text-white/50 text-base md:text-lg leading-relaxed max-w-xl">
              처음엔 작은 공간에서 시작하지만,<br />
              성장할수록 더 넓은 프로덕션으로 확장됩니다.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="group relative bg-white/[0.02] border border-white/10 hover:border-pink-400/40 transition duration-500 overflow-hidden">
              ...
              <div className="p-5 md:p-6 text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500 text-white text-xs font-bold tracking-[0.2em] shadow-[0_4px_20px_rgba(236,72,153,0.5)] mb-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-white" />
                  BEFORE
                </div>
                <h3 className="text-white text-lg md:text-xl font-bold">프로덕션의 시작</h3>
              </div>
            </div>
            ...
            <div className="group relative bg-white/[0.02] border border-white/10 hover:border-cyan-400/40 transition duration-500 overflow-hidden">
              ...
              <div className="p-5 md:p-6 text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-500 text-white text-xs font-bold tracking-[0.2em] shadow-[0_4px_20px_rgba(34,211,238,0.5)] mb-3">
                  AFTER
                  <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                </div>
                <h3 className="text-white text-lg md:text-xl font-bold">확장된 프로덕션</h3>
              </div>
            </div>
      ...
      <section id="news" className="snap-section relative min-h-screen pt-24 pb-20 md:pt-32 md:pb-24 overflow-hidden noise-bg">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 w-full relative z-10">
          ...
          <motion.div
            ...
            className="mt-10 md:mt-12 flex flex-col md:flex-row items-center justify-between gap-5 px-6 md:px-8 py-5 md:py-6 bg-white/[0.02] border border-white/10"
          >
            <div className="flex items-center gap-3 text-center md:text-left">
              <span className="inline-flex items-center justify-center w-2 h-2 rounded-full bg-pink-400 animate-pulse shrink-0" />
              <p className="text-white/80 text-sm md:text-base">
                최신 소식은 <span className="text-pink-300 font-semibold">공식 카페</span>에서도 확인할 수 있습니다.
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 pl-2 pr-5 py-2 rounded-full bg-[#03C75A] hover:bg-[#02b04f] text-white font-bold text-sm transition shadow-[0_4px_20px_rgba(3,199,90,0.3)] hover:shadow-[0_4px_25px_rgba(3,199,90,0.5)] hover:-translate-y-0.5 duration-300 shrink-0"
            >
              <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-white text-[#03C75A] font-black text-base">
                N
              </span>
              <span>공식 카페 바로가기</span>
